...
## R
The freely available software `r version$version.string` in combination with RStudio (version `r paste(analysis_info$Rstudio[1],analysis_info$Rstudio[2],analysis_info$Rstudio[3], sep = ".")`) was used. Installed packages are `r paste(package_list)`.
